...
const Start = () => {
  ...
  return (
    <div className="w-full h-full flex justify-center items-center px-5 py-24">
      {!showModal ? (
        <div className="flex flex-col items-center">
          <Logo />
          <button className="py-3 pl-5 pr-4 flex justify-center items-center gap-9 bg-yellow border-2 shadow-panel-shadow rounded-3xl mt-20">
          ...
          <button
            ...
            onClick={openModal}
          >
            <h3 className="text-night text-2xl font-bold">GAME RULES</h3>
          </button>
        </div>
      ) : (
        <div className="shadow-panel-shadow rounded-3xl bg-light pt-8 px-9 pb-14">
          ...
          <h2 className="text-semi-violet text-xl font-bold mt-7">OBJECTIVE</h2>
